...
def add_case(case_path="E:\\project_unittest\\Test_case",rule="test*.py"):
    '''第一步：加载所有的测试用例'''
...
def run_case(all_case):
    ...
    report_path='E:\\project_unittest\\Report'
    ...
    fp = open(filename, "wb")
    runner = HTMLtestRunnerScreenShot.HTMLTestRunner(stream=fp,
...
if __name__ == "__main__":
    ...
    # # 获取最新的测试报告文件
    report_path = 'E:\\project_unittest\\Report' # 用例文件夹
    report_file = get_report_file(report_path)  # 3获取最新的测试报告
    # #邮箱配置
    sender = "youemail"
    psw = "vnkbafuryetvghbj"   #不是你邮箱的密码，看此链接：https://blog.csdn.net/wateryouyo/article/details/51766345
    smtp_server = "smtp.qq.com"
    port = 465
    receiver = "receiver"  #接收者的邮箱
