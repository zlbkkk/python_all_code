...
class Node:
    def __init__(self,item):
        ...
        self.prev = None # 双向链表的前面的那个节点，前区
...
class DoubleLinkList:
    ...
    def add(self, item):
        ...
        node.next.prev = node # 让node的下一个节点（node.next）的节点的前驱空域指向node ,node.next.prev代表的是node下一个节点的前驱空域
    ...
    def append(self, item):
        ...
        if self.is_empty():
            ...
            cur.next = node
            node.prev = cur # 让最后插入的节点 node的前驱指向cur
